...
import com.src.model.UppercaseDocumentFilter;
...
public class JPCadastro extends javax.swing.JPanel {
    ...
    private void btCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCadastrarActionPerformed
        ...
        nomeMae = cmpNomeMae.getText();
        paciente = cmpPaciente.getText();
        local = (String)cmpLocal.getSelectedItem();
        vinculo = cmpVinculo.getText();
        entrada = cmpDtEntrada.getText();
        Visitante visitante = new Visitante(nome, nascimento, documento, nomeMae, paciente, local, vinculo, entrada.toString());
        Document doc = bd.inserir(visitante);
        bd.Add(doc);
        cmpNome.setText("");
        cmpDtNasc.setText("");
    ...
    private void cmpNomeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cmpNomeKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER || evt.getKeyCode() == KeyEvent.VK_ENTER){
            ...
            /*String[] aux = data.toJson().split(",");
            for(String a: aux)
                System.out.println(a);
            /*for (int i=0; i < data.size(); i++){
                if (data.getString("Documento:"))
            }*/
